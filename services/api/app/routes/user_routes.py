...
# login_manager is created unbound in config and attached by the factory; this
# module only registers the user_loader against it.
from app.config import db, login_manager
from app.level_predictor import predict_child_level
from app.models.child import Child, Level, LunchType
from app.models.learning_plan import LearningPlan
from app.models.parent import EducationLevel, Parent
from app.models.teacher import Teacher
from app.models.user import Role, User
from app.routes.auth import admin_required, child_required, parent_required, teacher_required
