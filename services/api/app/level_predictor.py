...
from app.config import basedir, db
from app.models.child import Child, Level
...
# The model is a service-level artifact beside templates/ and static/, not part
# of the app package -- ml_model.py writes it there.
model_path = Path(basedir) / 'level_prediction_model.joblib'
try:
