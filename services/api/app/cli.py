...
def import_content(path):
    ...
    from app.seeds import content as content_module
    ...
    try:
        ...
        import app.seeds.seeder as seeder_module
        from app.seeds.seeder import seed_content
...
def register_cli(app):
    """Attach the commands to an app built by the factory."""
    for command in (init_db, reset_db, create_admin, seed, check, import_content):
