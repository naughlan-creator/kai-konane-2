...
def _load_dotenv():
    """Read key=value pairs from a local .env, without overriding real env vars."""
...
if app.config['SQLALCHEMY_DATABASE_URI'].startswith('postgresql'):
    # Recycle connections so a managed Postgres that drops idle sockets does not
    # hand back a dead connection.
